...
<div class="container">
	<div class="row">
		...
		<div class="span10" id="user_content_div">
			<h2 class="heading-inline"><g:message code="org.synote.resource.compound.multimediaResource.createyt.title" /></h2>
			<hr/>
						...
						<div class="control-group span9">
						    ...
						    <div class="controls">
						    	<div class="input-append">
						        	...
						        	<p class="help-block">Please enter the URL of the YouTube Video <br/>e.g. http://www.youtube.com/watch?v=OM6XIICm_qo</p>
						        </div>
						    </div>
					    </div>
