...
<div class="cue-row row">
	<div class="span2">
		<div style="position:relative;">
			<g:link controller='recording' action='replay' id="${multimedia.id}" fragment="${row.mf}" title="play transcript block" params="[lang: params.lang]">
	  	...
	  	<div class="btn-group pull-right">
	 		<a href="#" data-toggle="dropdown" class="btn dropdown-toggle">
	  		...
	  		<ul class="dropdown-menu">
	  				<li class="divider"></li>
	  				<li><g:link controller="recording" action="replay" id="${multimedia.id}" fragment="${row.mf}" params="[lang: params.lang]">Play it in Synote Player</g:link></li>
	  				<li><g:link controller="recording" action="print" id="${multimedia.id}" fragment="${row.mf}" params="[lang: params.lang]">Print Friendly Version</g:link></li>
	 		</ul>
	 	</div>
	</div>
</div>