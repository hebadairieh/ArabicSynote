...
<h3 id="step2"><g:message code="Step.2" /></h3>
	<ul>
		...
		<li><g:message code="step2.2" /> </li>
		<li><g:message code="step2.3" /> </li>
	</ul>
...
<h3 id="step3"><g:message code="step.3" /></h3>
	<ul>
		...
		<li><g:message code="step3.2" /> </li>
		<li><b><g:message code="step3.3" /></b></li>
	</ul>
...
<h3 id="step4"><g:message code="step.4" /></h3>
	<ul>
		...
		<li><g:message code="step4.2" />.</li>
		<li><g:message code="step4.3" /> </li>
		<li><g:message code="step4.4" />. </li>
	</ul>
...
<h3 id="step5"><g:message code="step.5" /></h3>
	<ul>
		...
		<li><g:message code="step5.2" /> </li>
		<li><g:message code="step5.3" /> </li>
		<li><g:message code="step5.4" /> </li>
		<li><g:message code="step5.5" /> </li>
		<li><g:message code="step5.6" /> </li>
		<li><g:message code="step5.7" /> </li>
	</ul>
	<img src="${resource(dir:'images',file:"Step5small.jpg")}" alt="Step 5" class="img-responsive"/>
	</div>
